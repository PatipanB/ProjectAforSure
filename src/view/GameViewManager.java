...
public class GameViewManager {
	...
	private final static String BACKGROUND_PATH1 = ClassLoader.getSystemResource("view/resources/amazing_space1.jpg")
			.toString();
	private final static String BACKGROUND_PATH2 = ClassLoader.getSystemResource("view/resources/amazing_space2.jpg")
			.toString();
	private final static String BACKGROUND_PATH3 = ClassLoader.getSystemResource("view/resources/amazing_space3.jpg")
			.toString();
	private final static String BACKGROUND_PATH4 = ClassLoader.getSystemResource("view/resources/amazing_space4.jpg")
			.toString();

	private final static String METEORBROWN_PATH = ClassLoader.getSystemResource("view/resources/meteorBrown.png")
			.toString();
	private final static String METEORGREY_PATH = ClassLoader.getSystemResource("view/resources/meteorGrey.png")
			.toString();
	...
	private void checkIfElementCollide() {
		if (SHIP_RADIUS + STAR_RADIUS > calculateDistance(ship.getLayoutX() + 49, star.getLayoutX() + 16,
				ship.getLayoutY() + 38, star.getLayoutY() + 15)) {
			setNewElementPosition(star);
		...
		for (int i = 0; i < brownMeteors.length; i++) {
			if (SHIP_RADIUS + METEOR_RADIUS > calculateDistance(ship.getLayoutX() + 49,
					brownMeteors[i].getLayoutX() + 23, ship.getLayoutY() + 38, brownMeteors[i].getLayoutY() + 20)) {
				removeLife();
				setNewElementPosition(brownMeteors[i]);
			}
		}
		for (int i = 0; i < greyMeteors.length; i++) {
			if (SHIP_RADIUS + METEOR_RADIUS > calculateDistance(ship.getLayoutX() + 49,
					greyMeteors[i].getLayoutX() + 23, ship.getLayoutY() + 38, greyMeteors[i].getLayoutY() + 20)) {
				removeLife();
				setNewElementPosition(greyMeteors[i]);
			}
		}
